...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.48\linewidth}
		\includegraphics*[width=\linewidth]{plots/new_time_all_filtered_coreDel}
		\caption{time results for \coreDel{}}
	\end{subfigure}
	\caption{comparison of the running times of \adjDel{} (top left), \directDecomp{} (top right) and \coreDel{} (bottom) for all 3 data sets}\label{fig:all_runtimes_boxplot}
\end{figure}
...
We can see that for all three algorithms \fb{} produces by far the longest run time and that \directDecomp{} performs significantly better than \adjDel{} and \coreDel{} for \fb{}.
We first compare the run times of the three algorithms for the hpc data sets before we discuss the run times for \fb{} in greater detail.
...
\begin{figure}
	...
	\begin{minipage}{0.48\linewidth}
		\begin{subfigure}[b]{\linewidth}
			\includegraphics*[width=\linewidth]{plots/new_time_hpc_filtered_coreDel}
			\caption{time results for \coreDel{}}
		\end{subfigure}		
	\end{minipage}
	\begin{minipage}{0.48\linewidth}
		\begin{subfigure}[b]{\linewidth}
			\includegraphics*[width=\linewidth]{plots/new_barplot_time_hpc_filtered_coreDel}
			\caption{total time for \coreDel{}}
		\end{subfigure}		
	\end{minipage}
	\caption{comparison of the running times of \adjDel{} (top), \directDecomp{} (middle) and \coreDel{}(bottom) for both hpc traces}\label{fig:hpc_runtimes_boxplot_restricted}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics*[height=8cm]{plots/plot_facebook_time_to_size}
...
Finally we evaluate the cost of \adjDel{} and coreDel{}, i.e. both the communication as well 
as the migration cost, by comparing their results with those produced by \static{}.
...
\begin{figure}[h]
	...
	\begin{minipage}{0.48\linewidth}
		\begin{subfigure}[b]{\linewidth}
			\includegraphics*[width=\linewidth]{plots/plot_cost_coreDel}
			\caption{cost of \coreDel{}}
		\end{subfigure}	
	\end{minipage}
	\begin{subfigure}[b]{0.48\linewidth}
	...
	\end{subfigure}		
	\caption{comparison of the costs of \adjDel{} (top left), \coreDel{} (top right) and \static{} (right) for all 3 data sets}\label{fig:all_cost_barplot}
\end{figure}

\cref{fig:all_cost_barplot} shows the costs of \adjDel{} and \static{} for \fb{}, \dbmocfe{} and \dbnekbone{}.
Note that for \fb{} the cost of \adjDel{} (9932) is actually lower than the cost of \static{} (12491). The cost of \coreDel{} (10222) is only slightly larger than that of \adjDel{}.
 For the HPC traces \static{} is able to achieve significantly lower cost than the other algorithms.
