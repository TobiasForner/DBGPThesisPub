...
\begin{align*}
\core(C)=\{r=\new{(u,v)}\old{\{u,v\}}\in\sigma| (u,\reqTime(r))\in \epoch(C)\text{ and } (v, \reqTime(r))\in \epoch(C)\}.
\end{align*}
