...
\begin{lemma}
	...
	\begin{align*}
	\sum_{C\in\del(\sigma)}\optmig(C)+\optreq(C)\geq \new{\sum_{C\in\del(\sigma)}} |C|/k\cdot\alpha+|R(C)|/k
	\end{align*}
\end{lemma}
